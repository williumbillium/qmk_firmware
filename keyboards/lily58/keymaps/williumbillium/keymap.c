 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,       KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,   KC_LBRC,  KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                                  KC_LALT, KC_LGUI, RAISE,  KC_ENT,   KC_SPC,  LOWER,   KC_BSPC, KC_DEL
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, KC_WBAK,      KC_WFWD,     KC_VOLU,                   G(KC_LEFT), G(KC_DOWN), G(KC_UP), G(KC_RGHT), C(G(S(KC_4))), _______,
...
[_RAISE] = LAYOUT(
  ...
  _______, KC_TILD, KC_GRV,  _______, KC_LBRC, KC_RBRC,  _______, _______,  KC_0,    KC_1,    KC_2,    KC_3,    KC_DOT,  _______,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
